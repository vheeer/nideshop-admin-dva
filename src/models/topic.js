...
topic_category_id: ["topic_category_id", false, 'varchar', true, "varchar", {width: 150}, true],
       price_info: ["price_info", false, 'varchar', true, "varchar", {width: 150}, true],
       read_count: ["read_count", false, 'varchar', true, "varchar", {width: 150}, true],
    scene_pic_url: ["scene_pic_url", false, 'image', true, "image", {width: 150}, true],
topic_template_id: ["topic_template_id", false, 'varchar', true, "varchar", {width: 150}, true],
     topic_tag_id: ["topic_tag_id", false, 'varchar', true, "varchar", {width: 150}, true],
