 ...
 */
const columnMatch = {
               id: ["ID", true, 'varchar', true, "varchar required", {width: 80}, true],
            title: ["标题", true, 'varchar', true, "varchar", {width: 350}, true],
          content: ["内容", false, 'varchar', true, "varchar", {width: 150}, true],
           avatar: ["头像", true, 'image', true, "image", {width: 150}, true],
     item_pic_url: ["展示图", true, 'image', true, "image", {width: 150}, true],
         subtitle: ["描述", true, 'varchar', true, "varchar", {width: 150}, true],
topic_category_id: ["topic_category_id", false, 'varchar', false, "varchar", {width: 150}, true],
       price_info: ["price_info", false, 'varchar', false, "varchar", {width: 150}, true],
       read_count: ["read_count", false, 'varchar', false, "varchar", {width: 150}, true],
    scene_pic_url: ["scene_pic_url", false, 'image', false, "image", {width: 150}, true],
topic_template_id: ["topic_template_id", false, 'varchar', false, "varchar", {width: 150}, true],
     topic_tag_id: ["topic_tag_id", false, 'varchar', false, "varchar", {width: 150}, true],
