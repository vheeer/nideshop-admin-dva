...
goods_specification_ids: ["商品规格号", true, 'varchar', true, "varchar", {width: 150}, true],
               goods_sn: ["商品号", true, 'varchar', true, "varchar", {width: 150}, true],
           goods_number: ["数量", true, 'varchar', true, "varchar", {width: 150}, true],
           retail_price: ["价格", true, 'varchar', true, "money", {width: 150}, true],
