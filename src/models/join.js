...
const columnMatch = {
             ...
             pay_status: ["1-未支付；2-已支付", true, 'varchar', true, "varchar", {width: 150}, true],
       distribute_level: ["分销等级", true, 'varchar', true, "varchar", {width: 120}, true],
           out_trade_no: ["订单号", true, 'varchar', true, "varchar", {width: 120}, true],
              total_fee: ["金额（分）", true, 'varchar', true, "varchar", {width: 120}, true],
                 result: ["result", false, 'varchar', true, "varchar", {width: 120}, true],
                 attach: ["attach", false, 'varchar', true, "varchar", {width: 120}, true],
                referee: ["推荐人", true, 'varchar', true, "varchar", {width: 120}, true],
